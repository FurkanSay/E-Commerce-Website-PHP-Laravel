...
.masa{width: 95%; margin-right:15px; border:2px solid #ddd;}
.masa tr td{text-align: justify;}
.masa{float:right; text-align:left; width:40%; border:2px solid #ddd; margin-right:14px; margin-top: -4px; margin-right: 38px;}
.masa tr td{text-align:justify; padding: 5px 10px;}
.ordernow{}
