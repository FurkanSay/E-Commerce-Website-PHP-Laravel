...
class Customer
{
    ...
    public function customerRegistration($data)
    {
        ...
        $pass 		= mysqli_real_escape_string($this->db->link, base64_encode($pass));
        ...
        if ($mailchk != false) {
            ...
            $query = "INSERT INTO customers(name, address, city, country, zip, phone, email, pass) VALUES('$name', '$address', '$city', '$country', '$zip', '$phone', '$email', '$pass')";
